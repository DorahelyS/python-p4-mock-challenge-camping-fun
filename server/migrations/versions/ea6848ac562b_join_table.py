...
Revision ID: ea6848ac562b
Revises: c46649e38081
Create Date: 2024-01-16 10:17:06.607322
...
revision = 'ea6848ac562b'
down_revision = 'c46649e38081'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.add_column('signups', sa.Column('activity_id', sa.String(), nullable=True))
